...
def build_observables(config):
    return OSPMObservablesStellar.from_star_table( config["DATA_CSV"], inclination_deg=config["INCLINATION_DEG"], 
                                                  Norbit=config["NORBIT"], stellar_model=config.get("STELLAR_MODEL", None))
